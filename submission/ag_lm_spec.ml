...
module Spec : AG_Spec = struct
  ...
  ("Program", "main", ["ds"], ["s_VAR"; "s_IMP"; "s_MOD"; "s_LEX"; "s"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("ds"), "ok"), Bool(true))); AttrEq(AttrRef(VarE("top"), "s_VAR"), AttrRef(VarE("ds"), "s_VAR")); AttrEq(AttrRef(VarE("top"), "s_IMP"), AttrRef(VarE("ds"), "s_IMP")); AttrEq(AttrRef(VarE("top"), "s_MOD"), AttrRef(VarE("ds"), "s_MOD")); AttrEq(AttrRef(VarE("top"), "s_LEX"), AttrRef(VarE("ds"), "s_LEX")); AttrEq(AttrRef(VarE("_s_"), "VAR"), AttrRef(VarE("top"), "s_VAR")); AttrEq(AttrRef(VarE("_s_"), "IMP"), AttrRef(VarE("top"), "s_IMP")); AttrEq(AttrRef(VarE("_s_"), "MOD"), AttrRef(VarE("top"), "s_MOD")); AttrEq(AttrRef(VarE("_s_"), "LEX"), AttrRef(VarE("top"), "s_LEX")); AttrEq(AttrRef(VarE("top"), "s"), VarE("_s_")); NtaEq("_s_", TermE(TermT("mkScope", []))); AttrEq(AttrRef(VarE("ds"), "s"), AttrRef(VarE("top"), "s"))]);
  ...
  ("ActualDataDatumMod", "actualData", ["arg_0"], [], []);
  ...
  ("DeclImport", "decl", ["r"], ["p"; "d"; "s_mod"; "tgt_s"; "pair_1"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("r"), "ok"), And(TupleSec(AttrRef(VarE("top"), "pair_1"), 1), Bool(true)))); AttrEq(AttrRef(VarE("top"), "s_VAR"), AttrRef(VarE("r"), "s_VAR")); AttrEq(AttrRef(VarE("top"), "s_IMP"), Append(AttrRef(VarE("r"), "s_IMP"), Cons(AttrRef(VarE("top"), "s_mod"), Nil))); AttrEq(AttrRef(VarE("top"), "s_MOD"), AttrRef(VarE("r"), "s_MOD")); AttrEq(AttrRef(VarE("top"), "s_LEX"), AttrRef(VarE("r"), "s_LEX")); AttrEq(AttrRef(VarE("r"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "p"), AttrRef(VarE("r"), "p")); AttrEq(AttrRef(VarE("top"), "pair_1"), AttrRef(TermE(TermT("tgt", [AttrRef(VarE("top"), "p")])), "ret")); AttrEq(AttrRef(VarE("top"), "tgt_s"), TupleSec(AttrRef(VarE("top"), "pair_1"), 2)); AttrEq(AttrRef(VarE("top"), "d"), AttrRef(AttrRef(VarE("top"), "tgt_s"), "datum")); AttrEq(AttrRef(VarE("top"), "s_mod"), Case(AttrRef(VarE("top"), "d"), [(TermP("DatumMod", [UnderscoreP]), If(Bool(true), Let("d_lam_arg", AttrRef(VarE("top"), "d"), Let("dscope__", Case(AttrRef(VarE("d_lam_arg"), "data"), [(TermP("ActualDataDatumMod", [VarP("dscope")]), VarE("dscope")); (UnderscoreP, Abort("data match abort"))]), VarE("dscope__"))), Abort("branch case else TODO"))); (UnderscoreP, Abort("Match failure!"))]))]);
  ...
  ("ExprVar", "expr", ["r"], ["p"; "d"; "tgt_s"; "pair_2"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("r"), "ok"), And(TupleSec(AttrRef(VarE("top"), "pair_2"), 1), Bool(true)))); AttrEq(AttrRef(VarE("top"), "s_VAR"), AttrRef(VarE("r"), "s_VAR")); AttrEq(AttrRef(VarE("top"), "s_IMP"), AttrRef(VarE("r"), "s_IMP")); AttrEq(AttrRef(VarE("top"), "s_MOD"), AttrRef(VarE("r"), "s_MOD")); AttrEq(AttrRef(VarE("top"), "s_LEX"), AttrRef(VarE("r"), "s_LEX")); AttrEq(AttrRef(VarE("r"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "p"), AttrRef(VarE("r"), "p")); AttrEq(AttrRef(VarE("top"), "pair_2"), AttrRef(TermE(TermT("tgt", [AttrRef(VarE("top"), "p")])), "ret")); AttrEq(AttrRef(VarE("top"), "tgt_s"), TupleSec(AttrRef(VarE("top"), "pair_2"), 2)); AttrEq(AttrRef(VarE("top"), "d"), AttrRef(AttrRef(VarE("top"), "tgt_s"), "datum")); AttrEq(AttrRef(VarE("top"), "ty"), Case(AttrRef(VarE("top"), "d"), [(TermP("DatumVar", [UnderscoreP]), If(Bool(true), Let("d_lam_arg", AttrRef(VarE("top"), "d"), Let("dty__", Case(AttrRef(VarE("d_lam_arg"), "data"), [(TermP("ActualDataDatumVar", [VarP("dty")]), VarE("dty")); (UnderscoreP, Abort("data match abort"))]), VarE("dty__"))), Abort("branch case else TODO"))); (UnderscoreP, Abort("Match failure!"))]))]);
  ...
  ("ActualDataDatumVar", "actualData", ["arg_3"], [], []);
  ...
  ("tgt", "FunResult", ["p"], ["ok"; "s"; "pair_4"], [AttrEq(AttrRef(VarE("top"), "ok"), And(TupleSec(AttrRef(VarE("top"), "pair_4"), 1), Bool(true))); AttrEq(AttrRef(VarE("top"), "pair_4"), Case(AttrRef(VarE("top"), "p"), [(TermP("End", [VarP("x")]), If(Bool(true), Tuple([Bool(true); VarE("x")]), Abort("branch case else TODO"))); (TermP("Edge", [VarP("x"); VarP("l"); VarP("xs")]), If(Bool(true), AttrRef(TermE(TermT("tgt", [VarE("xs")])), "ret"), Abort("branch case else TODO"))); (UnderscoreP, Abort("Match failure!"))])); AttrEq(AttrRef(VarE("top"), "s"), TupleSec(AttrRef(VarE("top"), "pair_4"), 2)); AttrEq(AttrRef(VarE("top"), "ret"), Tuple([AttrRef(VarE("top"), "ok"); AttrRef(VarE("top"), "s")]))])  
