...
module Spec : AG_Spec = struct
  ...
  let prod_set = [
    ...
    ("ModRef", "mod-ref", ["x"], ["mods"; "xmods"; "xmods'"], [AttrEq(AttrRef(VarE("top"), "ok"), Bool(true)); AttrEq(AttrRef(VarE("top"), "s_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "mods"), AttrRef(TermE(TermT("query", [AttrRef(VarE("top"), "s"); TermE(TermT("regexSeq", [TermE(TermT("regexStar", [TermE(TermT("regexLabel", [TermE(TermT("labelLEX", []))]))])); TermE(TermT("regexSeq", [TermE(TermT("regexAlt", [TermE(TermT("regexLabel", [TermE(TermT("labelIMP", []))])); TermE(TermT("regexEps", []))])); TermE(TermT("regexLabel", [TermE(TermT("labelMOD", []))]))]))]))])), "ret")); AttrEq(AttrRef(VarE("top"), "xmods"), AttrRef(TermE(TermT("path_filter", [Fun("d_lam_arg", Case(VarE("d_lam_arg"), [(TermP("DatumMod", [VarP("x'")]), Equal(VarE("x'"), AttrRef(VarE("top"), "x"))); (UnderscoreP, Bool(false))])); AttrRef(VarE("top"), "mods")])), "ret")); AttrEq(AttrRef(VarE("top"), "xmods'"), AttrRef(TermE(TermT("path_min", [Fun("l", Fun("r", Case(Tuple([VarE("l"); VarE("r")]), [(TupleP([TermP("labelMOD", []); TermP("labelLEX", [])]), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelMOD", [])]), Int(1)); (TupleP([TermP("labelMOD", []); TermP("labelIMP", [])]), Int(-1)); (TupleP([TermP("labelIMP", []); TermP("labelMOD", [])]), Int(1)); (TupleP([TermP("labelVAR", []); TermP("labelLEX", [])]), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelVAR", [])]), Int(1)); (TupleP([TermP("labelVAR", []); TermP("labelIMP", [])]), Int(-1)); (TupleP([TermP("labelIMP", []); TermP("labelVAR", [])]), Int(1)); (TupleP([TermP("labelIMP", []); TermP("labelLEX", [])]), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelIMP", [])]), Int(1)); (TupleP([UnderscoreP; UnderscoreP]), Int(0))]))); AttrRef(VarE("top"), "xmods")])), "ret")); AttrEq(AttrRef(VarE("top"), "p"), AttrRef(TermE(TermT("one", [AttrRef(VarE("top"), "xmods'")])), "ret"))]);
    ("VarRef", "var-ref", ["x"], ["vars"; "xvars"; "xvars'"], [AttrEq(AttrRef(VarE("top"), "ok"), Bool(true)); AttrEq(AttrRef(VarE("top"), "s_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "vars"), AttrRef(TermE(TermT("query", [AttrRef(VarE("top"), "s"); TermE(TermT("regexSeq", [TermE(TermT("regexStar", [TermE(TermT("regexLabel", [TermE(TermT("labelLEX", []))]))])); TermE(TermT("regexSeq", [TermE(TermT("regexAlt", [TermE(TermT("regexLabel", [TermE(TermT("labelIMP", []))])); TermE(TermT("regexEps", []))])); TermE(TermT("regexLabel", [TermE(TermT("labelVAR", []))]))]))]))])), "ret")); AttrEq(AttrRef(VarE("top"), "xvars"), AttrRef(TermE(TermT("path_filter", [Fun("d_lam_arg", Case(VarE("d_lam_arg"), [(TermP("DatumVar", [VarP("x'")]), Equal(VarE("x'"), AttrRef(VarE("top"), "x"))); (UnderscoreP, Bool(false))])); AttrRef(VarE("top"), "vars")])), "ret")); AttrEq(AttrRef(VarE("top"), "xvars'"), AttrRef(TermE(TermT("path_min", [Fun("l", Fun("r", Case(Tuple([VarE("l"); VarE("r")]), [(TupleP([TermP("labelMOD", []); TermP("labelLEX", [])]), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelMOD", [])]), Int(1)); (TupleP([TermP("labelMOD", []); TermP("labelIMP", [])]), Int(-1)); (TupleP([TermP("labelIMP", []); TermP("labelMOD", [])]), Int(1)); (TupleP([TermP("labelVAR", []); TermP("labelLEX", [])]), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelVAR", [])]), Int(1)); (TupleP([TermP("labelVAR", []); TermP("labelIMP", [])]), Int(-1)); (TupleP([TermP("labelIMP", []); TermP("labelVAR", [])]), Int(1)); (TupleP([TermP("labelIMP", []); TermP("labelLEX", [])]), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelIMP", [])]), Int(1)); (TupleP([UnderscoreP; UnderscoreP]), Int(0))]))); AttrRef(VarE("top"), "xvars")])), "ret")); AttrEq(AttrRef(VarE("top"), "p"), AttrRef(TermE(TermT("one", [AttrRef(VarE("top"), "xvars'")])), "ret"))]);
    ...
    ("src", "FunResult", ["p"], ["ok"; "s"], [AttrEq(AttrRef(VarE("top"), "ok"), Bool(true)); AttrEq(AttrRef(VarE("top"), "s"), Case(AttrRef(VarE("top"), "p"), [(TermP("End", [VarP("x")]), If(Bool(true), VarE("x"), Abort("branch case else TODO"))); (TermP("Edge", [VarP("x"); VarP("l"); VarP("xs")]), If(Bool(true), VarE("x"), Abort("branch case else TODO"))); (UnderscoreP, Abort("Match failure!"))])); AttrEq(AttrRef(VarE("top"), "ret"), Tuple([AttrRef(VarE("top"), "ok"); AttrRef(VarE("top"), "s")]))])    
