...
```bash
./compile
java -jar lmr0.lmr.driver.jar inputs/letseq.lm
./clean
```
### Directories:
- `tests/`: LM example inputs directory at `../grammars/lm_syntax_0/inputs`.
- `out/`: created by the LM compiler if it does not already exist.
