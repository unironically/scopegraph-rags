...
let rec str_expr (e: expr): string =
  let rec str_cases (cs: case list): string =
    match cs with
    | [] -> ""
    | (p, c, e)::[] -> (str_pattern p) ^ " when " ^ (str_expr c) ^  " -> " ^ str_expr e
    | (p, c, e)::t  -> (str_pattern p) ^ " when " ^ (str_expr c) ^ " -> " ^ str_expr e ^ " | " ^ str_cases t
  in
  match e with
...
let prod_env: prod list = [
  ...
  ("DeclModule", "decl", ["x"; "ds"], ["s_mod_VAR"; "s_mod_IMP"; "s_mod_MOD"; "s_mod_LEX"; "s_mod"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("ds"), "ok"), Bool(true))); AttrEq(AttrRef(VarE("top"), "s_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_MOD"), Cons(AttrRef(VarE("top"), "s_mod"), Nil)); AttrEq(AttrRef(VarE("top"), "s_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "s_mod_VAR"), AttrRef(VarE("ds"), "s_VAR")); AttrEq(AttrRef(VarE("top"), "s_mod_IMP"), AttrRef(VarE("ds"), "s_IMP")); AttrEq(AttrRef(VarE("top"), "s_mod_MOD"), AttrRef(VarE("ds"), "s_MOD")); AttrEq(AttrRef(VarE("top"), "s_mod_LEX"), Append(Cons(AttrRef(VarE("top"), "s"), Nil), AttrRef(VarE("ds"), "s_LEX"))); AttrEq(AttrRef(VarE("s_mod"), "VAR"), AttrRef(VarE("top"), "s_mod_VAR")); AttrEq(AttrRef(VarE("s_mod"), "IMP"), AttrRef(VarE("top"), "s_mod_IMP")); AttrEq(AttrRef(VarE("s_mod"), "MOD"), AttrRef(VarE("top"), "s_mod_MOD")); AttrEq(AttrRef(VarE("s_mod"), "LEX"), AttrRef(VarE("top"), "s_mod_LEX")); NtaEq("s_mod_datum", TermE(TermT("DatumMod", [AttrRef(VarE("top"), "x")]))); AttrEq(AttrRef(VarE("s_mod_datum"), "data"), TermE(TermT("ActualDataDatumMod", [AttrRef(VarE("top"), "s_mod")]))); AttrEq(AttrRef(VarE("top"), "s_mod"), VarE("s_mod")); NtaEq("s_mod", TermE(TermT("mkScope", []))); AttrEq(AttrRef(VarE("s_mod"), "datum"), VarE("s_mod_datum")); AttrEq(AttrRef(VarE("ds"), "s"), AttrRef(VarE("top"), "s_mod"))]);
  ("DeclImport", "decl", ["r"], ["p"; "d"; "s_mod"; "tgt_s"; "pair_0"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("r"), "ok"), And(TupleSec(AttrRef(VarE("top"), "pair_0"), 1), Bool(true)))); AttrEq(AttrRef(VarE("top"), "s_VAR"), AttrRef(VarE("r"), "s_VAR")); AttrEq(AttrRef(VarE("top"), "s_IMP"), Append(AttrRef(VarE("r"), "s_IMP"), Cons(AttrRef(VarE("top"), "s_mod"), Nil))); AttrEq(AttrRef(VarE("top"), "s_MOD"), AttrRef(VarE("r"), "s_MOD")); AttrEq(AttrRef(VarE("top"), "s_LEX"), AttrRef(VarE("r"), "s_LEX")); AttrEq(AttrRef(VarE("r"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "p"), AttrRef(VarE("r"), "p")); AttrEq(AttrRef(VarE("top"), "pair_0"), AttrRef(TermE(TermT("tgt", [AttrRef(VarE("top"), "p")])), "ret")); AttrEq(AttrRef(VarE("top"), "tgt_s"), TupleSec(AttrRef(VarE("top"), "pair_0"), 2)); AttrEq(AttrRef(VarE("top"), "d"), AttrRef(AttrRef(VarE("top"), "tgt_s"), "datum")); AttrEq(AttrRef(VarE("top"), "s_mod"), Case(AttrRef(VarE("top"), "d"), [(TermP("DatumMod", [UnderscoreP]), Bool(true), If(Bool(true), Let("d_lam_arg", AttrRef(VarE("top"), "d"), Let("dscope__", Case(AttrRef(VarE("d_lam_arg"), "data"), [(TermP("ActualDataDatumMod", [VarP("dscope")]), Bool(true), VarE("dscope")); (UnderscoreP, Bool(true), Abort("data match abort"))]), VarE("dscope__"))), Abort("branch case else TODO"))); (UnderscoreP, Bool(true), Abort("Match failure!"))]))]);
  ...
  ("ExprVar", "expr", ["r"], ["p"; "d"; "tgt_s"; "pair_1"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("r"), "ok"), And(TupleSec(AttrRef(VarE("top"), "pair_1"), 1), Bool(true)))); AttrEq(AttrRef(VarE("top"), "s_VAR"), AttrRef(VarE("r"), "s_VAR")); AttrEq(AttrRef(VarE("top"), "s_IMP"), AttrRef(VarE("r"), "s_IMP")); AttrEq(AttrRef(VarE("top"), "s_MOD"), AttrRef(VarE("r"), "s_MOD")); AttrEq(AttrRef(VarE("top"), "s_LEX"), AttrRef(VarE("r"), "s_LEX")); AttrEq(AttrRef(VarE("r"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "p"), AttrRef(VarE("r"), "p")); AttrEq(AttrRef(VarE("top"), "pair_1"), AttrRef(TermE(TermT("tgt", [AttrRef(VarE("top"), "p")])), "ret")); AttrEq(AttrRef(VarE("top"), "tgt_s"), TupleSec(AttrRef(VarE("top"), "pair_1"), 2)); AttrEq(AttrRef(VarE("top"), "d"), AttrRef(AttrRef(VarE("top"), "tgt_s"), "datum")); AttrEq(AttrRef(VarE("top"), "ty"), Case(AttrRef(VarE("top"), "d"), [(TermP("DatumVar", [UnderscoreP]), Bool(true), If(Bool(true), Let("d_lam_arg", AttrRef(VarE("top"), "d"), Let("dty__", Case(AttrRef(VarE("d_lam_arg"), "data"), [(TermP("ActualDataDatumVar", [VarP("dty")]), Bool(true), VarE("dty")); (UnderscoreP, Bool(true), Abort("data match abort"))]), VarE("dty__"))), Abort("branch case else TODO"))); (UnderscoreP, Bool(true), Abort("Match failure!"))]))]);
  ...
  ("ExprApp", "expr", ["e1"; "e2"], ["ty1"; "ty2"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("e1"), "ok"), And(AttrRef(VarE("e2"), "ok"), And(Case(AttrRef(VarE("top"), "ty1"), [(TermP("TFun", [VarP("l"); VarP("r")]), Bool(true), If(Bool(true), Equal(AttrRef(VarE("top"), "ty2"), VarE("l")), Abort("branch case else TODO"))); (UnderscoreP, Bool(true), Abort("Match failure!"))]), Bool(true))))); AttrEq(AttrRef(VarE("top"), "s_VAR"), Append(AttrRef(VarE("e1"), "s_VAR"), AttrRef(VarE("e2"), "s_VAR"))); AttrEq(AttrRef(VarE("top"), "s_IMP"), Append(AttrRef(VarE("e1"), "s_IMP"), AttrRef(VarE("e2"), "s_IMP"))); AttrEq(AttrRef(VarE("top"), "s_MOD"), Append(AttrRef(VarE("e1"), "s_MOD"), AttrRef(VarE("e2"), "s_MOD"))); AttrEq(AttrRef(VarE("top"), "s_LEX"), Append(AttrRef(VarE("e1"), "s_LEX"), AttrRef(VarE("e2"), "s_LEX"))); AttrEq(AttrRef(VarE("e1"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "ty1"), AttrRef(VarE("e1"), "ty")); AttrEq(AttrRef(VarE("e2"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "ty2"), AttrRef(VarE("e2"), "ty")); AttrEq(AttrRef(VarE("top"), "ty"), Case(AttrRef(VarE("top"), "ty1"), [(TermP("TFun", [VarP("l"); VarP("r")]), Bool(true), If(Bool(true), VarE("r"), Abort("branch case else TODO"))); (UnderscoreP, Bool(true), Abort("Match failure!"))]))]);
  ...
  ("DefBindSeq", "seq-bind", ["x"; "e"], ["s_var_VAR"; "s_var_IMP"; "s_var_MOD"; "s_var_LEX"; "s_var"; "ty"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("e"), "ok"), Bool(true))); AttrEq(AttrRef(VarE("top"), "s_VAR"), Append(Cons(AttrRef(VarE("top"), "s_var"), Nil), AttrRef(VarE("e"), "s_VAR"))); AttrEq(AttrRef(VarE("top"), "s_IMP"), AttrRef(VarE("e"), "s_IMP")); AttrEq(AttrRef(VarE("top"), "s_MOD"), AttrRef(VarE("e"), "s_MOD")); AttrEq(AttrRef(VarE("top"), "s_LEX"), AttrRef(VarE("e"), "s_LEX")); AttrEq(AttrRef(VarE("top"), "s_def_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_LEX"), Nil); AttrEq(AttrRef(VarE("s_var"), "VAR"), AttrRef(VarE("top"), "s_var_VAR")); AttrEq(AttrRef(VarE("s_var"), "IMP"), AttrRef(VarE("top"), "s_var_IMP")); AttrEq(AttrRef(VarE("s_var"), "MOD"), AttrRef(VarE("top"), "s_var_MOD")); AttrEq(AttrRef(VarE("s_var"), "LEX"), AttrRef(VarE("top"), "s_var_LEX")); NtaEq("s_var_datum", TermE(TermT("DatumVar", [AttrRef(VarE("top"), "x")]))); AttrEq(AttrRef(VarE("s_var_datum"), "data"), TermE(TermT("ActualDataDatumVar", [AttrRef(VarE("top"), "ty")]))); AttrEq(AttrRef(VarE("top"), "s_var"), VarE("s_var")); NtaEq("s_var", TermE(TermT("mkScope", []))); AttrEq(AttrRef(VarE("s_var"), "datum"), VarE("s_var_datum")); AttrEq(AttrRef(VarE("e"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "ty"), AttrRef(VarE("e"), "ty"))]);
  ("DefBindTypedSeq", "seq-bind", ["x"; "tyann"; "e"], ["s_var_VAR"; "s_var_IMP"; "s_var_MOD"; "s_var_LEX"; "s_var"; "ty"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("tyann"), "ok"), And(AttrRef(VarE("e"), "ok"), Bool(true)))); AttrEq(AttrRef(VarE("top"), "s_VAR"), Append(Cons(AttrRef(VarE("top"), "s_var"), Nil), Append(AttrRef(VarE("tyann"), "s_VAR"), AttrRef(VarE("e"), "s_VAR")))); AttrEq(AttrRef(VarE("top"), "s_IMP"), Append(AttrRef(VarE("tyann"), "s_IMP"), AttrRef(VarE("e"), "s_IMP"))); AttrEq(AttrRef(VarE("top"), "s_MOD"), Append(AttrRef(VarE("tyann"), "s_MOD"), AttrRef(VarE("e"), "s_MOD"))); AttrEq(AttrRef(VarE("top"), "s_LEX"), Append(AttrRef(VarE("tyann"), "s_LEX"), AttrRef(VarE("e"), "s_LEX"))); AttrEq(AttrRef(VarE("top"), "s_def_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_LEX"), Nil); AttrEq(AttrRef(VarE("s_var"), "VAR"), AttrRef(VarE("top"), "s_var_VAR")); AttrEq(AttrRef(VarE("s_var"), "IMP"), AttrRef(VarE("top"), "s_var_IMP")); AttrEq(AttrRef(VarE("s_var"), "MOD"), AttrRef(VarE("top"), "s_var_MOD")); AttrEq(AttrRef(VarE("s_var"), "LEX"), AttrRef(VarE("top"), "s_var_LEX")); NtaEq("s_var_datum", TermE(TermT("DatumVar", [AttrRef(VarE("top"), "x")]))); AttrEq(AttrRef(VarE("s_var_datum"), "data"), TermE(TermT("ActualDataDatumVar", [AttrRef(VarE("top"), "ty")]))); AttrEq(AttrRef(VarE("top"), "s_var"), VarE("s_var")); NtaEq("s_var", TermE(TermT("mkScope", []))); AttrEq(AttrRef(VarE("s_var"), "datum"), VarE("s_var_datum")); AttrEq(AttrRef(VarE("tyann"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "ty"), AttrRef(VarE("tyann"), "ty")); AttrEq(AttrRef(VarE("e"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "ty"), AttrRef(VarE("e"), "ty"))]);
  ...
  ("DefBindPar", "par-bind", ["x"; "e"], ["s_var_VAR"; "s_var_IMP"; "s_var_MOD"; "s_var_LEX"; "s_var"; "ty"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("e"), "ok"), Bool(true))); AttrEq(AttrRef(VarE("top"), "s_VAR"), AttrRef(VarE("e"), "s_VAR")); AttrEq(AttrRef(VarE("top"), "s_IMP"), AttrRef(VarE("e"), "s_IMP")); AttrEq(AttrRef(VarE("top"), "s_MOD"), AttrRef(VarE("e"), "s_MOD")); AttrEq(AttrRef(VarE("top"), "s_LEX"), AttrRef(VarE("e"), "s_LEX")); AttrEq(AttrRef(VarE("top"), "s_def_VAR"), Cons(AttrRef(VarE("top"), "s_var"), Nil)); AttrEq(AttrRef(VarE("top"), "s_def_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_LEX"), Nil); AttrEq(AttrRef(VarE("s_var"), "VAR"), AttrRef(VarE("top"), "s_var_VAR")); AttrEq(AttrRef(VarE("s_var"), "IMP"), AttrRef(VarE("top"), "s_var_IMP")); AttrEq(AttrRef(VarE("s_var"), "MOD"), AttrRef(VarE("top"), "s_var_MOD")); AttrEq(AttrRef(VarE("s_var"), "LEX"), AttrRef(VarE("top"), "s_var_LEX")); NtaEq("s_var_datum", TermE(TermT("DatumVar", [AttrRef(VarE("top"), "x")]))); AttrEq(AttrRef(VarE("s_var_datum"), "data"), TermE(TermT("ActualDataDatumVar", [AttrRef(VarE("top"), "ty")]))); AttrEq(AttrRef(VarE("top"), "s_var"), VarE("s_var")); NtaEq("s_var", TermE(TermT("mkScope", []))); AttrEq(AttrRef(VarE("s_var"), "datum"), VarE("s_var_datum")); AttrEq(AttrRef(VarE("e"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "ty"), AttrRef(VarE("e"), "ty"))]);
  ("DefBindTypedPar", "par-bind", ["x"; "tyann"; "e"], ["s_var_VAR"; "s_var_IMP"; "s_var_MOD"; "s_var_LEX"; "s_var"; "ty"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("tyann"), "ok"), And(AttrRef(VarE("e"), "ok"), Bool(true)))); AttrEq(AttrRef(VarE("top"), "s_VAR"), Append(AttrRef(VarE("tyann"), "s_VAR"), AttrRef(VarE("e"), "s_VAR"))); AttrEq(AttrRef(VarE("top"), "s_IMP"), Append(AttrRef(VarE("tyann"), "s_IMP"), AttrRef(VarE("e"), "s_IMP"))); AttrEq(AttrRef(VarE("top"), "s_MOD"), Append(AttrRef(VarE("tyann"), "s_MOD"), AttrRef(VarE("e"), "s_MOD"))); AttrEq(AttrRef(VarE("top"), "s_LEX"), Append(AttrRef(VarE("tyann"), "s_LEX"), AttrRef(VarE("e"), "s_LEX"))); AttrEq(AttrRef(VarE("top"), "s_def_VAR"), Cons(AttrRef(VarE("top"), "s_var"), Nil)); AttrEq(AttrRef(VarE("top"), "s_def_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_def_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_LEX"), Nil); AttrEq(AttrRef(VarE("s_var"), "VAR"), AttrRef(VarE("top"), "s_var_VAR")); AttrEq(AttrRef(VarE("s_var"), "IMP"), AttrRef(VarE("top"), "s_var_IMP")); AttrEq(AttrRef(VarE("s_var"), "MOD"), AttrRef(VarE("top"), "s_var_MOD")); AttrEq(AttrRef(VarE("s_var"), "LEX"), AttrRef(VarE("top"), "s_var_LEX")); NtaEq("s_var_datum", TermE(TermT("DatumVar", [AttrRef(VarE("top"), "x")]))); AttrEq(AttrRef(VarE("s_var_datum"), "data"), TermE(TermT("ActualDataDatumVar", [AttrRef(VarE("top"), "ty")]))); AttrEq(AttrRef(VarE("top"), "s_var"), VarE("s_var")); NtaEq("s_var", TermE(TermT("mkScope", []))); AttrEq(AttrRef(VarE("s_var"), "datum"), VarE("s_var_datum")); AttrEq(AttrRef(VarE("tyann"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "ty"), AttrRef(VarE("tyann"), "ty")); AttrEq(AttrRef(VarE("e"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "ty"), AttrRef(VarE("e"), "ty"))]);
  ("ArgDecl", "arg-decl", ["x"; "tyann"], ["s_var_VAR"; "s_var_IMP"; "s_var_MOD"; "s_var_LEX"; "s_var"], [AttrEq(AttrRef(VarE("top"), "ok"), And(AttrRef(VarE("tyann"), "ok"), Bool(true))); AttrEq(AttrRef(VarE("top"), "s_VAR"), Append(AttrRef(VarE("tyann"), "s_VAR"), Cons(AttrRef(VarE("top"), "s_var"), Nil))); AttrEq(AttrRef(VarE("top"), "s_IMP"), AttrRef(VarE("tyann"), "s_IMP")); AttrEq(AttrRef(VarE("top"), "s_MOD"), AttrRef(VarE("tyann"), "s_MOD")); AttrEq(AttrRef(VarE("top"), "s_LEX"), AttrRef(VarE("tyann"), "s_LEX")); AttrEq(AttrRef(VarE("top"), "s_var_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_var_LEX"), Nil); AttrEq(AttrRef(VarE("tyann"), "s"), AttrRef(VarE("top"), "s")); AttrEq(AttrRef(VarE("top"), "ty"), AttrRef(VarE("tyann"), "ty")); AttrEq(AttrRef(VarE("s_var"), "VAR"), AttrRef(VarE("top"), "s_var_VAR")); AttrEq(AttrRef(VarE("s_var"), "IMP"), AttrRef(VarE("top"), "s_var_IMP")); AttrEq(AttrRef(VarE("s_var"), "MOD"), AttrRef(VarE("top"), "s_var_MOD")); AttrEq(AttrRef(VarE("s_var"), "LEX"), AttrRef(VarE("top"), "s_var_LEX")); NtaEq("s_var_datum", TermE(TermT("DatumVar", [AttrRef(VarE("top"), "x")]))); AttrEq(AttrRef(VarE("s_var_datum"), "data"), TermE(TermT("ActualDataDatumVar", [AttrRef(VarE("top"), "ty")]))); AttrEq(AttrRef(VarE("top"), "s_var"), VarE("s_var")); NtaEq("s_var", TermE(TermT("mkScope", []))); AttrEq(AttrRef(VarE("s_var"), "datum"), VarE("s_var_datum"))]);
  ...
  ("ModRef", "mod-ref", ["x"], ["mods"; "xmods"; "xmods'"], [AttrEq(AttrRef(VarE("top"), "ok"), Bool(true)); AttrEq(AttrRef(VarE("top"), "s_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "mods"), AttrRef(TermE(TermT("query", [AttrRef(VarE("top"), "s"); TermE(TermT("regexSeq", [TermE(TermT("regexStar", [TermE(TermT("regexLabel", [TermE(TermT("labelLEX", []))]))])); TermE(TermT("regexSeq", [TermE(TermT("regexAlt", [TermE(TermT("regexLabel", [TermE(TermT("labelIMP", []))])); TermE(TermT("regexEps", []))])); TermE(TermT("regexLabel", [TermE(TermT("labelMOD", []))]))]))]))])), "ret")); AttrEq(AttrRef(VarE("top"), "xmods"), AttrRef(TermE(TermT("path_filter", [Fun("d_lam_arg", Case(VarE("d_lam_arg"), [(TermP("DatumMod", [VarP("x'")]), Bool(true), Equal(VarE("x'"), AttrRef(VarE("top"), "x"))); (UnderscoreP, Bool(true), Bool(false))])); AttrRef(VarE("top"), "mods")])), "ret")); AttrEq(AttrRef(VarE("top"), "xmods'"), AttrRef(TermE(TermT("path_min", [Fun("l", Fun("r", Case(Tuple([VarE("l"); VarE("r")]), [(TupleP([TermP("labelMOD", []); TermP("labelLEX", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelMOD", [])]), Bool(true), Int(1)); (TupleP([TermP("labelMOD", []); TermP("labelIMP", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelIMP", []); TermP("labelMOD", [])]), Bool(true), Int(1)); (TupleP([TermP("labelVAR", []); TermP("labelLEX", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelVAR", [])]), Bool(true), Int(1)); (TupleP([TermP("labelVAR", []); TermP("labelIMP", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelIMP", []); TermP("labelVAR", [])]), Bool(true), Int(1)); (TupleP([TermP("labelIMP", []); TermP("labelLEX", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelIMP", [])]), Bool(true), Int(1)); (TupleP([UnderscoreP; UnderscoreP]), Bool(true), Int(0))]))); AttrRef(VarE("top"), "xmods")])), "ret")); AttrEq(AttrRef(VarE("top"), "p"), AttrRef(TermE(TermT("one", [AttrRef(VarE("top"), "xmods'")])), "ret"))]);
  ("VarRef", "var-ref", ["x"], ["vars"; "xvars"; "xvars'"], [AttrEq(AttrRef(VarE("top"), "ok"), Bool(true)); AttrEq(AttrRef(VarE("top"), "s_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "vars"), AttrRef(TermE(TermT("query", [AttrRef(VarE("top"), "s"); TermE(TermT("regexSeq", [TermE(TermT("regexStar", [TermE(TermT("regexLabel", [TermE(TermT("labelLEX", []))]))])); TermE(TermT("regexSeq", [TermE(TermT("regexAlt", [TermE(TermT("regexLabel", [TermE(TermT("labelIMP", []))])); TermE(TermT("regexEps", []))])); TermE(TermT("regexLabel", [TermE(TermT("labelVAR", []))]))]))]))])), "ret")); AttrEq(AttrRef(VarE("top"), "xvars"), AttrRef(TermE(TermT("path_filter", [Fun("d_lam_arg", Case(VarE("d_lam_arg"), [(TermP("DatumVar", [VarP("x'")]), Bool(true), Equal(VarE("x'"), AttrRef(VarE("top"), "x"))); (UnderscoreP, Bool(true), Bool(false))])); AttrRef(VarE("top"), "vars")])), "ret")); AttrEq(AttrRef(VarE("top"), "xvars'"), AttrRef(TermE(TermT("path_min", [Fun("l", Fun("r", Case(Tuple([VarE("l"); VarE("r")]), [(TupleP([TermP("labelMOD", []); TermP("labelLEX", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelMOD", [])]), Bool(true), Int(1)); (TupleP([TermP("labelMOD", []); TermP("labelIMP", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelIMP", []); TermP("labelMOD", [])]), Bool(true), Int(1)); (TupleP([TermP("labelVAR", []); TermP("labelLEX", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelVAR", [])]), Bool(true), Int(1)); (TupleP([TermP("labelVAR", []); TermP("labelIMP", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelIMP", []); TermP("labelVAR", [])]), Bool(true), Int(1)); (TupleP([TermP("labelIMP", []); TermP("labelLEX", [])]), Bool(true), Int(-1)); (TupleP([TermP("labelLEX", []); TermP("labelIMP", [])]), Bool(true), Int(1)); (TupleP([UnderscoreP; UnderscoreP]), Bool(true), Int(0))]))); AttrRef(VarE("top"), "xvars")])), "ret")); AttrEq(AttrRef(VarE("top"), "p"), AttrRef(TermE(TermT("one", [AttrRef(VarE("top"), "xvars'")])), "ret"))]);
  ("tgt", "FunResult", ["p"], ["ok"; "s"], [AttrEq(AttrRef(VarE("top"), "ok"), Bool(true)); AttrEq(AttrRef(VarE("top"), "s"), Case(AttrRef(VarE("top"), "p"), [(TermP("End", [VarP("x")]), Bool(true), If(Bool(true), VarE("x"), Abort("branch case else TODO"))); (TermP("Edge", [VarP("x"); VarP("l"); VarP("xs")]), Bool(true), If(Bool(true), AttrRef(TermE(TermT("tgt", [VarE("xs")])), "ret"), Abort("branch case else TODO"))); (UnderscoreP, Bool(true), Abort("Match failure!"))])); AttrEq(AttrRef(VarE("top"), "ret"), Tuple([AttrRef(VarE("top"), "ok"); AttrRef(VarE("top"), "s")]))]);
  ("src", "FunResult", ["p"], ["ok"; "s"], [AttrEq(AttrRef(VarE("top"), "ok"), Bool(true)); AttrEq(AttrRef(VarE("top"), "s"), Case(AttrRef(VarE("top"), "p"), [(TermP("End", [VarP("x")]), Bool(true), If(Bool(true), VarE("x"), Abort("branch case else TODO"))); (TermP("Edge", [VarP("x"); VarP("l"); VarP("xs")]), Bool(true), If(Bool(true), VarE("x"), Abort("branch case else TODO"))); (UnderscoreP, Bool(true), Abort("Match failure!"))])); AttrEq(AttrRef(VarE("top"), "ret"), Tuple([AttrRef(VarE("top"), "ok"); AttrRef(VarE("top"), "s")]))]);
  ("foo", "FunResult", ["s"; "p"], ["ok"; "s_VAR"; "s_IMP"; "s_MOD"; "s_LEX"; "s_ret"; "p1"; "p2"; "s'"], [AttrEq(AttrRef(VarE("top"), "ok"), Bool(true)); AttrEq(AttrRef(VarE("top"), "s_VAR"), Nil); AttrEq(AttrRef(VarE("top"), "s_IMP"), Nil); AttrEq(AttrRef(VarE("top"), "s_MOD"), Nil); AttrEq(AttrRef(VarE("top"), "s_LEX"), Nil); AttrEq(AttrRef(VarE("top"), "p2"), TermE(TermT("End", [AttrRef(VarE("top"), "s'")]))); AttrEq(AttrRef(VarE("top"), "p1"), AttrRef(VarE("top"), "p2")); AttrEq(AttrRef(VarE("top"), "s_ret"), Case(AttrRef(VarE("top"), "p"), [(TermP("End", [UnderscoreP]), Bool(true), If(Bool(true), AttrRef(VarE("top"), "s'"), Abort("branch case else TODO"))); (TermP("Edge", [UnderscoreP; UnderscoreP; UnderscoreP]), Bool(true), If(Bool(true), AttrRef(VarE("top"), "s'"), Abort("branch case else TODO"))); (UnderscoreP, Bool(true), Abort("Match failure!"))])); AttrEq(AttrRef(VarE("top"), "ret"), Tuple([AttrRef(VarE("top"), "ok"); AttrRef(VarE("top"), "s_VAR"); AttrRef(VarE("top"), "s_IMP"); AttrRef(VarE("top"), "s_MOD"); AttrRef(VarE("top"), "s_LEX"); AttrRef(VarE("top"), "s_ret")]))]);
    ...
    [
      AttrEq(AttrRef(VarE("top"), "ret"),
        Case(Tuple([AttrRef(VarE("top"), "p1"); AttrRef(VarE("top"), "p2")]), [
          ...
          (TupleP([TermP("End", [UnderscoreP]); TermP("End", [UnderscoreP])]), Bool(true), Int(0));
          (TupleP([TermP("End", [UnderscoreP]); UnderscoreP]), Bool(true), Int(-1));
          (TupleP([UnderscoreP; TermP("End", [UnderscoreP])]), Bool(true), Int(1));
        ])
      )
    ]
  );
    ...
    [
      AttrEq(AttrRef(VarE("top"), "ret"),
        Case(AttrRef(VarE("top"), "ps"), [
          (NilP, Bool(true), Nil);
          (ConsP(VarP("hp"), VarP("t")), Bool(true),
            AttrRef(

              TermE(TermT("list_fold_right", [
                Fun("item", Fun("acc", 
                  Let("hd", Case(VarE("acc"), [(ConsP(VarP("h"), UnderscoreP), Bool(true), VarE("h"))]),
    ...
    [
      AttrEq(AttrRef(VarE("top"), "ret"),
        Case(AttrRef(VarE("top"), "lst"), [
          (ConsP(VarP("h"), NilP), Bool(true),
            (* -> *) VarE("h"));
          (UnderscoreP, Bool(true),
          ...
          TermE(TermT("list_fold_right", [
            Fun("p", Fun("acc",
              Let ("pTgt", AttrRef(TermE(TermT("tgt", [VarE("p")])), "ret"),
                Case(VarE("pTgt"), [
                  (TupleP([VarP("ok_"); VarP("s_")]), Bool(true),
                    If (
    ...
    [
      AttrEq(AttrRef(VarE("top"), "ret"),
        Case(AttrRef(VarE("top"), "r"), [
          ( (* sym a *)
            TermP("regexLabel", [VarP("a")]), Bool(true),
            (* -> *) Bool(false)
          );
          ( (* eps *)
          ...
          ( (* star *)
            TermP("regexStar", [VarP("sub")]), Bool(true),
            (* -> *) Bool(true)
          );
          ( (* cat *)
            TermP("regexSeq", [VarP("r1"); VarP("r2")]), Bool(true),
            (* -> *) AttrRef(TermE(TermT("nullableAnd", [VarE("r1"); VarE("r2")])), "ret")
          );
          ( (* and *)
            TermP("regexAnd", [VarP("r1"); VarP("r2")]), Bool(true),
            (* -> *) AttrRef(TermE(TermT("nullableAnd", [VarE("r1"); VarE("r2")])), "ret")
          );
          ( (* or *)
            TermP("regexAlt", [VarP("r1"); VarP("r2")]), Bool(true),
            (* -> *) AttrRef(TermE(TermT("nullableOr", [VarE("r1"); VarE("r2")])), "ret")
          );
          ( (* not *)
            TermP("regexNeg", [VarP("sub")]), Bool(true),
    ...
    [
      AttrEq(AttrRef(VarE("top"), "ret"), 
        Case(AttrRef(VarE("top"), "r"), [
          ...
          ( (* sym b *)
          TermP("regexLabel", [VarP("b")]), Bool(true),
    ...
    [
      AttrEq(AttrRef(VarE("top"), "ret"),
        Case(AttrRef(VarE("top"), "l"), [
          (TermP("labelLEX", []), Bool(true), AttrRef(VarE("s"), "LEX"));
          (TermP("labelVAR", []), Bool(true), AttrRef(VarE("s"), "VAR"));
          (TermP("labelIMP", []), Bool(true), AttrRef(VarE("s"), "IMP"));
          (TermP("labelMOD", []), Bool(true), AttrRef(VarE("s"), "MOD"))
        ])
      )
    ]
  );
  ...
  (
    ...
    [
      AttrEq(AttrRef(VarE("top"), "ret"),
        Case(AttrRef(VarE("top"), "r"), [
          ( (* sym a *)
            TermP("regexLabel", [VarP("a")]), Bool(true), (* -> *) Bool(false)
          );
          ( (* eps *)
            TermP("regexEps", []), Bool(true), (* -> *) Bool(false)
          );
          ( (* emptyset *)
            TermP("regexEmptySet", []), Bool(true), (* -> *) Bool(true)
          );
          ( (* star *)
            TermP("regexStar", [VarP("sub")]), Bool(true), (* -> *) 
    ...
    [
      AttrEq(AttrRef(VarE("top"), "ret"),
        Case(AttrRef(VarE("top"), "r"), [
          ...
          ( (* eps *)
            TermP("regexEps", []), Bool(true), (* -> *) Bool(true)
          );
          ( (* emptyset *)
            TermP("regexEmptySet", []), Bool(true), (* -> *) Bool(false)
          );
          ( (* star *)
            TermP("regexStar", [VarP("sub")]), Bool(true), (* -> *) Bool(false)
          );
          ( (* cat *)
            TermP("regexSeq", [VarP("r1"); VarP("r2")]), Bool(true),
            (* -> *) And (
      ...
      AttrEq(AttrRef(VarE("top"), "ret"),
        If(AttrRef(TermE(TermT("isEmptySet", [AttrRef(VarE("top"), "r")])), "ret"),
          ...
          If(AttrRef(TermE(TermT("isEpsilon", [AttrRef(VarE("top"), "r")])), "ret"),
            ...
            (*Case(AttrRef(VarE("s"), "datum"), [(UnderscoreP, Bool(true), Bool(true))]),*)
...
let instantiate_eqs_set (name: string) (node: node_id) (eqs: set): set =
  ...
  and instantiate_case ((p, c, e): case): case =
    (p, instantiate_expr c, instantiate_expr e)
...
let rec substitute_expr (s: string) (e': expr) (e: expr): expr =
  let substitute_case ((p, c, e): case): case =
    (p, substitute_expr s e' c, substitute_expr s e' e)
  in
...
let rec mk_tree (n: node_id) (TermT(p, es): term): tree =
  ...
  let rec match_children (ch_decls: prod_child list)
    ...
    | [], []         -> []
    | cd::cds, TermE(t)::es when nt_name <> "FunResult" -> let child_node_id = mk_node_id cd in
...
(* todo description *)
let rec unify_one_aux (p: pattern) (e: expr) ((tree, stk, eqs): eq_step_state): ((string * expr) list) option =
  match p with
  | TermP(s, ps) -> 
      (match e with
      ...
      | TermE(TermT(s', es)) when s = s' && List.length ps == List.length es ->
          let sub_unify: (((string * expr) list) option) list =
            List.map2 (fun ps es -> unify_one_aux ps es (tree, stk, eqs)) ps es
          in
          let all_some: bool =
      ...
      | NodeRef(n) ->
          ...
          let res = unify_one_aux p e' (tree, stk, eqs) in
          res
  ...
  | ConsP(hp, tp) -> (match e with Cons(he, te) -> let unify_h = unify_one_aux hp he (tree, stk, eqs) in
                                                  let unify_t = unify_one_aux tp te (tree, stk, eqs) in
  ...
  | TupleP(ps)   -> 
      ...
      | Tuple(es) -> 
          let sub_unify: (((string * expr) list) option) list =
            List.map2 (fun ps es -> unify_one_aux ps es (tree, stk, eqs)) ps es in
          let all_some: bool =
 ...
 *)
and unify_one (p: pattern) (c: expr) (e: expr) ((tree, stk, eqs): eq_step_state): ((string * expr) list) option =
  let rec reduce_cond_to_val (c: expr) ((tree', stk', eqs'): eq_step_state): expr =
    if value_expr c
    then c
    else let (c', tree'', stk'', eqs'') = expr_step (c, tree', stk', eqs') in
         if value_expr c' then c' else reduce_cond_to_val c' (tree'', stk'', eqs'')
  in
  let resBinds: ((string * expr) list) option =
    unify_one_aux p e (tree, stk, eqs)
  in
  if Option.is_none resBinds 
  then
    None
  else
    let c': expr = List.fold_right (fun (s, e') e -> substitute_expr s e' e) (Option.get resBinds) c in
    if c = Bool(true)
    then resBinds
    else None 
...
and unify_lst (ps: case list) (e: expr) ((tree, stk, eqs): eq_step_state): (((string * expr) list) * expr) option =
  ...
  | [] -> None
  | (p, c, e')::rest ->
      let unify_binds: ((string * expr) list) option = unify_one p c e (tree, stk, eqs) in
...
and expr_step (e, t, s, eqs: expr_step_state): expr_step_state =
  ...
  | AttrRef(NodeRef(n), a) -> 
      ...
      | Demanded -> (print_state (t, s, eqs)); 
                    raise (Failure ("Cycle detected from attribute " ^ n ^ "." ^ a ^ " - exiting"))
...
let rec eq_step (t, s, eqs: eq_step_state): eq_step_state =
  ...
  | NtaEq(n, e)::rest when value_expr e ->
      ...
      let () = if (String.starts_with "#_tgtres" n) then print_endline "------------------------------------------------------------------------------- found #_tgtres in step-nta-build" else ()
      in
  ...
  | NtaEq(n, e)::rest when not(value_expr e) ->
    let () = if (String.starts_with "#_tgtres" n) then print_endline "------------------------------------------------------------------------------- found #_tgtres in step-on-expr-nta" else ()
    in
