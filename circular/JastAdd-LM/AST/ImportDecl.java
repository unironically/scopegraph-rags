...
/**
 * @ast node
 * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/_AST_LM.ast:9
...
public class ImportDecl extends Decl implements Cloneable {
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/PrettyPrint.jrag:34
   */
   ...
   * @attribute syn
   * @aspect Scoping
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Scoping.jrag:257
   */
   ...
   * @apilevel internal
   */
  private ArrayList<Resolution> impTentatives_compute() { return getRef().impTentatives(); }
  /**
   * @apilevel internal
   */
   ...
   * @attribute syn
   * @aspect Scoping
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Scoping.jrag:259
   */
   ...
   * @apilevel internal
   */
  private ArrayList<MkVarRef> refs_compute() {  return getRef().refs();  }
  /**
   * @apilevel internal
   */
   ...
   * @attribute syn
   * @aspect Scoping
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Scoping.jrag:261
   */
   ...
   * @apilevel internal
   */
  private ArrayList<Scope> scopes_compute() {  return getRef().scopes();  }
  /**
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Scoping.jrag:254
   * @apilevel internal
   */
