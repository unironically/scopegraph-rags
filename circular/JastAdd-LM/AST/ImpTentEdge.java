...
/**
 * @ast node
 * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/_AST_Scope.ast:27
 * @production ImpTentEdge : {@link Edge} ::= <span class="component">src:{@link Scope}</span>;

 */
public class ImpTentEdge extends Edge implements Cloneable {
  /**
   * @apilevel internal
   */
  public ImpTentEdge clone() throws CloneNotSupportedException {
    ImpTentEdge node = (ImpTentEdge) super.clone();
   ...
   * @apilevel internal
   */
  public ImpTentEdge copy() {
    try {
      ImpTentEdge node = (ImpTentEdge) clone();
      node.parent = null;
      if(children != null) {
   ...
   * @apilevel low-level
   */
  public ImpTentEdge fullCopy() {
    ImpTentEdge tree = (ImpTentEdge) copy();
    if (children != null) {
