...
/**
 * @ast node
 * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/_AST_DFA.ast:3
 * @production ModDFA : {@link DFA};

 */
public class ModDFA extends DFA implements Cloneable {
  /**
   * @apilevel internal
   */
  public ModDFA clone() throws CloneNotSupportedException {
    ModDFA node = (ModDFA) super.clone();
   ...
   * @apilevel low-level
   */
  public ModDFA fullCopy() {
    ModDFA tree = (ModDFA) copy();
    if (children != null) {
   ...
   * @attribute syn
   * @aspect Resolution
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Resolution.jrag:73
   */
   ...
   * @attribute syn
   * @aspect Resolution
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Resolution.jrag:78
   */
  ...
  /**
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Resolution.jrag:94
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Resolution.jrag:95
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Resolution.jrag:96
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/Resolution.jrag:97
   * @apilevel internal
   */
