...
/**
 * @ast node
 * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/_AST_Scope.ast:22
 * @production LexEdge : {@link Edge} ::= <span class="component">src:{@link Scope}</span>;

 */
public class LexEdge extends Edge implements Cloneable {
  /**
   * @apilevel internal
   */
  public LexEdge clone() throws CloneNotSupportedException {
    LexEdge node = (LexEdge) super.clone();
   ...
   * @apilevel low-level
   */
  public LexEdge fullCopy() {
    LexEdge tree = (LexEdge) copy();
    if (children != null) {
