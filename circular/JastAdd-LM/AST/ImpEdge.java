...
/**
 * @ast node
 * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/_AST_Scope.ast:24
 * @production ImpEdge : {@link Edge} ::= <span class="component">src:{@link Scope}</span>;

 */
public class ImpEdge extends Edge implements Cloneable {
  /**
   * @apilevel internal
   */
  public ImpEdge clone() throws CloneNotSupportedException {
    ImpEdge node = (ImpEdge) super.clone();
   ...
   * @apilevel low-level
   */
  public ImpEdge fullCopy() {
    ImpEdge tree = (ImpEdge) copy();
    if (children != null) {
