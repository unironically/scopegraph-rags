...
/**
 * @ast node
 * @declaredat /home/luke/Academia/personal/scopegraph-rags/circular/JastAdd-LM/spec/_AST_Scope.ast:26
 * @production VarEdge : {@link Edge} ::= <span class="component">src:{@link Scope}</span>;

 */
public class VarEdge extends Edge implements Cloneable {
  /**
   * @apilevel internal
   */
  public VarEdge clone() throws CloneNotSupportedException {
    VarEdge node = (VarEdge) super.clone();
   ...
   * @apilevel low-level
   */
  public VarEdge fullCopy() {
    VarEdge tree = (VarEdge) copy();
    if (children != null) {
