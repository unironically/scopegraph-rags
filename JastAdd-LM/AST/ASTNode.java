...
public class ASTNode<T extends ASTNode> implements Cloneable, Iterable<T> {
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /home/luke/Academia/melt/downstreams/scopegraph-rags/JastAdd-LM/spec/PrettyPrint.jrag:86
   */
   ...
   */
    ...
    for(int i = 0; i < getNumChild(); i++) {
      getChild(i).collect_contributors_Scope_lexScopes();
    }
  }
   ...
   */
    ...
    for(int i = 0; i < getNumChild(); i++) {
      getChild(i).collect_contributors_Scope_modScopes();
    }
  }
   ...
   */
    ...
    for(int i = 0; i < getNumChild(); i++) {
      getChild(i).collect_contributors_Scope_varScopes();
    }
  }
   ...
   */
    ...
    for(int i = 0; i < getNumChild(); i++) {
      getChild(i).collect_contributors_Scope_impScopes();
    }
  }
