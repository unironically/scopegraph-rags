...
/**
 * @ast node
 * @declaredat /home/luke/Academia/melt/downstreams/scopegraph-rags/JastAdd-LM/spec/_AST_DFA.ast:15
 * @production FinalState : {@link State};

 */
public class FinalState extends State implements Cloneable {
  /**
   * @apilevel internal
   */
  public FinalState clone() throws CloneNotSupportedException {
    FinalState node = (FinalState) super.clone();
   ...
   * @apilevel internal
   */
  public FinalState copy() {
    try {
      FinalState node = (FinalState) clone();
      node.parent = null;
      if(children != null) {
   ...
   * @apilevel low-level
   */
  public FinalState fullCopy() {
    FinalState tree = (FinalState) copy();
    if (children != null) {
  ...
  /**
   */
  public FinalState(Integer p0, State p1, State p2, State p3, State p4, Boolean p5) {
    setId(p0);
    setChild(p1, 0);
    setChild(p2, 1);
    setChild(p3, 2);
   ...
   * @attribute syn
   * @aspect Resolution
   * @declaredat /home/luke/Academia/melt/downstreams/scopegraph-rags/JastAdd-LM/spec/Resolution.jrag:167
   */
