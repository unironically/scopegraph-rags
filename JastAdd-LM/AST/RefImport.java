...
/**
 * @ast node
 * @declaredat /home/luke/Academia/melt/downstreams/scopegraph-rags/JastAdd-LM/spec/_AST_Scope.ast:11
 * @production RefImport : {@link Ref};

 */
public class RefImport extends Ref implements Cloneable {
  /**
   * @apilevel internal
   */
  public RefImport clone() throws CloneNotSupportedException {
    RefImport node = (RefImport) super.clone();
    node.dfa_visited = -1;
   ...
   * @apilevel internal
   */
  public RefImport copy() {
    try {
      RefImport node = (RefImport) clone();
      node.parent = null;
      if(children != null) {
   ...
   * @apilevel low-level
   */
  public RefImport fullCopy() {
    RefImport tree = (RefImport) copy();
    if (children != null) {
  ...
  /**
   */
  public RefImport(String p0, Scope p1) {
    setId(p0);
    setChild(p1, 0);
    is$Final(true);
  }
   ...
   * @attribute syn
   * @aspect Resolution
   * @declaredat /home/luke/Academia/melt/downstreams/scopegraph-rags/JastAdd-LM/spec/Resolution.jrag:14
   */
  public DFA dfa() {
    if(dfa_computed) {
      return dfa_value;
   ...
   * @attribute syn
   * @aspect Resolution
   * @declaredat /home/luke/Academia/melt/downstreams/scopegraph-rags/JastAdd-LM/spec/Resolution.jrag:221
   */
